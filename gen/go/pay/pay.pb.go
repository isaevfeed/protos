...
type BuyResponse struct {
	...
	Buyed  bool  `protobuf:"varint,1,opt,name=buyed,proto3" json:"buyed,omitempty"`
...
func (x *BuyResponse) GetBuyed() bool {
	if x != nil {
		return x.Buyed
	}
	return false
...
func (x *BuyResponse) GetItemId() int64 {
	if x != nil {
		return x.ItemId
	}
	return 0
...
func (x *BuyResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *SellRequest) GetItemId() int64 {
	if x != nil {
		return x.ItemId
	}
	return 0
...
type SellResponse struct {
	...
	Selled bool  `protobuf:"varint,1,opt,name=selled,proto3" json:"selled,omitempty"`
	ItemId int64 `protobuf:"varint,2,opt,name=item_id,json=itemId,proto3" json:"item_id,omitempty"`
	UserId int64 `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
}
...
func (x *SellResponse) GetSelled() bool {
	if x != nil {
		return x.Selled
	}
	return false
...
func (x *SellResponse) GetItemId() int64 {
	if x != nil {
		return x.ItemId
	}
	return 0
...
func (x *SellResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
var file_pay_pay_proto_rawDesc = []byte{
	...
	0x03, 0x70, 0x61, 0x79, 0x22, 0x25, 0x0a, 0x0a, 0x42, 0x75, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x06, 0x69, 0x74, 0x65, 0x6d, 0x49, 0x64, 0x22, 0x55, 0x0a, 0x0b, 0x42,
	0x75, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x62, 0x75,
	0x79, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x62, 0x75, 0x79, 0x65, 0x64,
	...
	0x49, 0x64, 0x22, 0x3f, 0x0a, 0x0b, 0x53, 0x65, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x72, 0x49, 0x64, 0x22, 0x58, 0x0a, 0x0c, 0x53, 0x65, 0x6c, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x65, 0x6c, 0x6c, 0x65, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x06, 0x73, 0x65, 0x6c, 0x6c, 0x65, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x69,
	...
	,
...
var file_pay_pay_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pay_pay_proto_goTypes = []interface{}{
	(*BuyRequest)(nil),   // 0: pay.BuyRequest
	(*BuyResponse)(nil),  // 1: pay.BuyResponse
	(*SellRequest)(nil),  // 2: pay.SellRequest
	(*SellResponse)(nil), // 3: pay.SellResponse
}
var file_pay_pay_proto_depIdxs = []int32{
	0, // 0: pay.Payment.Buy:input_type -> pay.BuyRequest
	2, // 1: pay.Payment.Sell:input_type -> pay.SellRequest
	1, // 2: pay.Payment.Buy:output_type -> pay.BuyResponse
	3, // 3: pay.Payment.Sell:output_type -> pay.SellResponse
